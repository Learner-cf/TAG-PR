# borrowed and modified from https://github.com/QinYang79/RDE/tree/main, thanks!
...
class VisualEmbeddingLayer(nn.Module):
    ...
    def forward(self, atten, base_features, training=True):
        # if atten.size(1) == 198:
        #     atten = atten[:, :-1, :-1]

        k = int((base_features.size(1) - 1) * self.ratio)  # 192
